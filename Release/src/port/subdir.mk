...
src/port/%.o: ../src/port/%.cpp
	...
	/usr/local/cuda-8.0/bin/nvcc -I../include -I../src/OSA_IPC/inc -I../src/OSA_CAP/inc -I../src/plantCtrl -I../src/ptz -I../src/port -I/usr/include/GL -I/usr/local/cuda-8.0/include -O3 -std=c++11 -ccbin aarch64-linux-gnu-g++ -gencode arch=compute_53,code=sm_53 -m64 -odir "src/port" -M -o "$(@:%.o=%.d)" "$<"
