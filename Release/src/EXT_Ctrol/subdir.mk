...
src/EXT_Ctrol/%.o: ../src/EXT_Ctrol/%.cpp
	...
	/usr/local/cuda-8.0/bin/nvcc -I../include -I../src/OSA_IPC/inc -I../src/OSA_CAP/inc -I../src/plantCtrl -I../src/ptz -I../src/port -O3 -ccbin aarch64-linux-gnu-g++ -gencode arch=compute_53,code=sm_53 -m64 -odir "src/EXT_Ctrol" -M -o "$(@:%.o=%.d)" "$<"
